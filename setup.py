...
setuptools.setup(
    ...
    project_urls={
        'Source Code': 'https://github.com/Irrational-Encoding-Wizardry/vs-transitions',
        'Documentation': 'https://vstransitions.encode.moe/en/latest/',
